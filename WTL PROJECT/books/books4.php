...
<br>
<img src="books4.jpg" height="450" style="position:absolute;left:50px;top:170px;border-radius:8px;shadow:20px 20px white;"></img>
<p id="here"></p>
<br>  
<div style="position:absolute;left:750px;top:170px;">
<p><h1><b>Sour Heart</b></h1><H4>by Jenny Zhang<br><br>Price: &#x20b9;479<br><br>Star Rating:<br>
...
Centered on a community of immigrants who have traded their endangered <br>
lives as artists in China and Taiwan for the constant struggle of life at the <br>
poverty line in 1990s New York City, Zhang's collection examines the many ways<br>
 that family and history can weigh us down and also lift us up.<br><br>
<span class="read-more-target">From the young woman 
coming to terms with her grandmother's role in the Cultural Revolution<br> to the daughter
 struggling to understand where her family ends and she begins, to the girl discovering <br>
the power of her body to inspire and destroy, these seven stories illuminate the complex <br>
and messy inner lives of girls struggling to define themselves
 </span></p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="position:relative;float:left; left:735px;top:170;">
  ...
  <input type="image" name="submit"
    ...
    alt="Add to Cart" value="sour heart">
	<br>
<br>
	 </div>
</form>
