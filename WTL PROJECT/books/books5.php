...
<br>
<img src="books5.jpg" height="450" style="position:absolute;left:50px;top:170px;border-radius:8px;shadow:20px 20px white;"></img>
<p id="here"></p>
<br>  
<div style="position:absolute;left:720px;top:170px;">
<p><h1><b>What We Lose</b></h1><H4>by Zinzi Clemmons<br><br>Price: &#x20b9;478<br><br>Star Rating:<br>
...
From an author of rare, haunting power, a stunning novel about a young African-American <br>
woman coming of age-a deeply felt meditation on race, sex, family, and country<br><br>

Raised in Pennsylvania, Thandi views the world of her mother's childhood in Johannesburg<br>
 as both impossibly distant and ever present. She is an outsider wherever she goes, caught<br>
 between being black and white, American and not.
<span class="read-more-target">
 She tries to connect these dislocated <br>
pieces of her life, and as her mother succumbs to cancer,<br> Thandi searches for an anchor-someone, or something, to love. <br><br>

In arresting and unsettling prose, we watch Thandi's life unfold, <br>from losing her mother
 and learning to live without the person who has most profoundly <br>shaped her existence, 
to her own encounters with romance and unexpected motherhood. <br>Through exquisite and emotional 
vignettes, Clemmons creates a stunning portrayal of what it means<br> to choose to live, after loss.
 An elegiac distillation, at once intellectual and visceral, of a<br> young woman's understanding
 of absence and identity that spans continents and decades, What We <br>Lose heralds the
 arrival of a virtuosic new voice in fiction.
 </span></p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="position:relative;float:left; left:735px;top:170;">
  ...
  <input type="image" name="submit"
    ...
    alt="Add to Cart" value="what we lose">
	<br>
<br>
	 </div>
</form>
