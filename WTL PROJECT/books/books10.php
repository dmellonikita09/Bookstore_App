...
<br>
<img src="books10.jpg" height="450" style="position:absolute;left:50px;top:170px;border-radius:8px;shadow:20px 20px white;"></img>
<p id="here"></p>
<br>  
<div style="position:absolute;left:750px;top:170;text-align:center;">
<p><h1><b>Exit West</b></h1><H4>by by Mohsin Hamid<br><br>Price: &#x20b9;450<br><br>Star Rating:<br>
...
In a country teetering on the brink of civil war, two young people<br>
 meet-sensual, fiercely independent Nadia and gentle, restrained Saeed.<br>
 They embark on a furtive love affair and are soon cloistered in <br>
premature intimacy by the unrest roiling their city.
<span class="read-more-target">
 When it explodes, <br>
turning familiar streets into a patchwork of checkpoints and bomb blasts, <br>
they begin to hear whispers about doors-doors that can whisk people far away,<br>
 if perilously and for a price. As the violence escalates, Nadia and Saeed <br>
decide that they no longer have a choice. Leaving their homeland and their <br>
old lives behind, they find a door and step through. <br>

Exit West follows these characters as they emerge into an alien and<br>
 uncertain future, struggling to hold on to each other, to their past,<br>
 to the very sense of who they are. Profoundly intimate and powerfully <br>
inventive, it tells an unforgettable story of love, loyalty, and courage <br>
that is both completely of our time and for all time.
 </span></p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="position:relative;float:left; left:735px;top:170;">
  ...
  <input type="image" name="submit"
    ...
    alt="Add to Cart" value="exit west">
	<br>
<br>
	 </div>
</form>
