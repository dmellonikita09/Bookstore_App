...
<center>
 <div class="nav navbar-nav">
	  <form action="addcart.php" method="GET"><form action="addcart.php" method="GET">
<br>
<img src="books6.jpg" height="450"style="position:absolute;left:50px;top:170px;border-radius:8px;shadow:20px 20px white;"></img>
<p id="here"></p>
<br>  
<div style="position:absolute;left:750px;top:170;text-align:center;">
<p><h1><b>Pachinko</b></h1><H4>by Min Jin Lee<br><br>Price: &#x20b9;918<br><br>Star Rating:<br>
...
Pachinko follows one Korean family through the generations,<br> 
beginning in early 1900s Korea with Sunja, the prized daughter<br>
<span class="read-more-target">
of a poor yet proud family, whose unplanned pregnancy threatens<br>
to shame them all. Deserted by her lover, Sunja is saved when<br>
a young tubercular minister offers to marry and bring her to Japan.<br>
So begins a sweeping saga of an exceptional family in exile from its<br>
homeland and caught in the indifferent arc of history. Through desperate<br>
struggles and hard-won triumphs, its members are bound together by <br>
deep roots as they face enduring questions of faith, family, and identity.
 </span></p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="position:relative;float:left; left:735px;top:170;">
  ...
  <input type="image" name="submit"
    ...
    alt="Add to Cart" value="pachinko">
	<br>
<br>
	 </div>
</form>
