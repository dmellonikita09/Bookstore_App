...
<br>
<img src="books12.jpg" height="450" style="position:absolute;left:70px;top:180px;border-radius:8px;shadow:20px 20px white;"></img>
<p id="here"></p>
<br>  
<div style="position:absolute;left:710px;top:170px;">
<p><h1><b>One Indian Girl</b></h1><H4>by Chetan Bhagat<br><br>Price: &#x20b9;96<br><br>Star Rating:<br>
...
Hi, I'm Radhika Mehta and I'm getting married this week.<br>
 I work at Goldman Sachs, an investment bank. Thank you<br>
 for reading my story. However, let me warn you.<br>

You may not like me too much.
<span class="read-more-target">
 One, I make a lot of money.<br> 
Two, I have an opinion on everything. Three, I have had a <br>
boyfriend before. OK, maybe two.<br>

Now if all this was the case with a guy, one might be <br>
cool with it. But since I am a girl these three things<br>
 I mentioned don't really make me too likeable, do they?
 </span></p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="position:relative;float:left; left:735px;top:170;">
  ...
  <input type="image" name="submit"
    ...
    alt="Add to Cart" value="one indian girl">
	<br>
<br>
	 </div>
</form>
