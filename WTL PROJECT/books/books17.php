...
<br>
<img src="books17.jpg" height="450" style="position:absolute;left:50px;top:170px;border-radius:8px;shadow:20px 20px white;"></img>
<p id="here"></p>
<br>  
<div style="position:absolute;left:550px;top:170px;">
<p><h1><b>2 States: The Story of My Marriage</b></h1><H4>by Chetan Bhagat<br><br>Price: &#x20b9;160<br><br>Star Rating:<br>
...
<div width="100" style="text-align:justify;position:relative;left:650px;top:160;font-size:15;">
 ...
 Welcome to 2 States, a story about Krish and Ananya.<br>
 They are from two different states of India, deeply in<br>
 love and want to get married. Of course, their parents <br>
don t agrees. 
<span class="read-more-target">
To convert their love story into a love<br>
 marriage, the couple have a tough battle in front of them.<br>
  For it is easy to fight and rebel, but it is much harder<br>
 to convince. Will they make it? 
 </span></p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="position:relative;float:left; left:735px;top:170;">
  ...
  <input type="image" name="submit"
    ...
    alt="Add to Cart" value="2 states">
	<br>
<br>
	 </div>
</form>
