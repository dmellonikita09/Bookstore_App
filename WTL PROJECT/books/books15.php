...
<br>
<img src="books15.jpg" height="450" style="position:absolute;left:50px;top:170px;border-radius:8px;shadow:20px 20px white;"></img>
<p id="here"></p>
<br>  
<div style="position:absolute;left:640px;top:170px;">
<p><h1><b>Making India Awesome</b></h1><H4>by Chetan Bhagat<br><br>Price: &#x20b9;160<br><br>Star Rating:<br>
...
'Making India Awesome: New Essays and Columns' by renowned Indian<br> author Chetan Bhagat is a book that showers light on India's most <br>obstinate snags-unemployment, violence, poverty, discrimination <br>against women, religious fundamentalism, illiteracy and communal violence.<br><br>
<span class="read-more-target">
 This is the first time Chetan Bhagat, renowned for writing
 non-fiction<br> books based on the lives of Indian youth, has 
tried his hand at writing<br> non-fictional contents with 'Making
 India Awesome' being a collection <br>of essays that discusses
 some of the most prevalent problems prevailing in India.
 </span></p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div style="position:relative;float:left; left:735px;top:170;">
  ...
  <input type="image" name="submit"
    ...
    alt="Add to Cart" value="making india awesome">
	<br>
<br>
	 </div>
</form>
